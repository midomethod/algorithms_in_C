...
int main(int argc, char** argv)
{
    ...
    while(getline(input,command)) // get next line of input, store as repeat
    {
        ...
        if(strcmp(op,"lca") == 0) // delete from list
        {
            cout << "The LCA pointer is: " << myBST.lca(val,val2) << endl;
            cout << "The LCA key for " << val << " and " << val2 << " is: " << endl;
            if(myBST.lca(val,val2)!= NULL)
            {
                cout<< myBST.lca(val,val2)->key << endl;
            }
            cout << endl;
            output << myBST.lca(val,val2) << endl;
            cout << 99 << endl;
            continue;
        }
        ...
        {
            output << myBST.width() << endl; // write printed tree to file, and add new line
            cout << "The width is:" << myBST.width() << endl;
            
        }
     }
     cout << 1 << endl;
     myBST.deleteBST(); // delete the tree from 
     cout << 2 << endl;
     input.close();
     cout << 3 << endl;
     output.close();
